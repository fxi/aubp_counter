...
function _update() {
  _update = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    var date, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            date = e && e.target.value ? new Date(e.target.value) : new Date();
            _context.next = 3;
...
function getDelta(_x2) {
  return _getDelta.apply(this, arguments);
}

function _getDelta() {
  _getDelta = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(date) {
    var t, t1, t2, strQ, res, count;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            t = new Date(date);
            t1 = t.setHours(7, 0, 0, 0);
            t2 = t.setHours(21, 0, 0, 0);
            strQ = "{\nzoneById(zoneId: ".concat(config.idZone, "){\n    id\n    name\n    installation { address }\n    counts(\n    eventId: ").concat(config.idEvent, ", \n    dates:  [").concat(t1, ", ").concat(t2, "]) { \n    dateBegin \n    dateEnd \n    eventId \n    periodId \n    in \n    out\n    }\n  }\n}");
            _context2.next = 6;
            return query(strQ);

          case 6:
            res = _context2.sent;
            count = res.zoneById.counts[0];
...
function _query() {
  _query = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(str) {
    var res, value;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 8:
            return _context3.abrupt("return", value.data);
...
//# sourceMappingURL=/aubp_counter.e31bb0bc.js.map